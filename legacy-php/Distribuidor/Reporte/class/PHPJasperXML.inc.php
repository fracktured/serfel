...
//### End of modification
    ...
    public function outpage($out_method="I",$filename="") {
        ...
        //$this->pdf->addTTFfont("./pchart2/fonts/verdana.ttf", 'TrueTypeUnicode', '', 32);
        //$this->arrayPageSetting["language"]=$xml_path["language"];
...
//echo $sql."<br/><br/>";
    ...
    $legendfontsize=8;
    $this->chart->setFontProperties(array('FontName'=>"$pchartfolder/fonts/" . $this->font,'FontSize'=>$legendfontsize));
...
$Title=$data['charttitle']['text'];
    ...
    $this->chart->setFontProperties(array('FontName'=>"$pchartfolder/fonts/" . $this->font,'FontSize'=>8));
...
$titlefontname=strtolower($titlefontname);
    ...
    $this->chart->drawText($w/3,($titlefontsize+10),$Title,$textsetting);
      ...
      $this->chart->setFontProperties(array('FontName'=>"$pchartfolder/fonts/" . $this->font,'FontSize'=>7));
...
//###                        $this->group_count=0;
	...
	public function printlongtext($fontfamily,$fontstyle,$fontsize){
					...
					//$this->pdf->SetFont($fontfamily,$fontstyle,$fontsize);
                                        $this->pdf->SetFont($this->fontfamily,$fontstyle,$fontsize);
    ...
    elseif($arraydata["rotation"]=="UpsideDown"){
       ...
       // $arraydata["width"]=$arraydata["height"];
        ...
        if($arraydata["type"]=="SetFont") {
            ...
            $this->pdf->SetFont($this->fontfamily,$arraydata["fontstyle"],$arraydata["fontsize"]);
