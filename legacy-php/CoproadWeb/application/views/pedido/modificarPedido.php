<html ng-app="ModificarPedido">
    ...
    <head>
        ...
        <title>SerfelWeb :: Modificar Pedido</title>
        
        <script src="<?= asset_url(); ?>angularApp/pedido/modificarPedido.js"></script>
		...
		<script>
			...
			// 		if(bandera == true)
			// 		{
			// 			window.history.pushState('', null, 'modificarPedido');
			// 		}
    ...
    <div class="">
		...
		<div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel" ng-controller="ModificarPedidoController">
...
<!--                             <div class="col-md-12 col-sm-12 col-xs-6" style="background-color:red; height: 20px;">
						...
						<div class="table-responsive col-md-12 col-sm-12 col-xs-12">
							<div ng-repeat="producto in productos track by $index" class="ng-cloak col-md-12 col-sm-12 col-xs-12 table-striped table-hover" ng-click="ingresarDetallePedido({ producto:producto, indice: $index, esModificacion: true});">
								...
								<div class="col-md-1 col-sm-1 hidden-xs">{{producto.cantidad_stock | number | comaPorPunto}}</div>
						...
						<div class="col-md-12 col-sm-12 col-xs-12 text-right" style="padding-right: 0px">
							<button class="btn btn-primary" ng-click="crearPedidoProductos(productos)" ng-disabled="crearPedidoClicked">Modificar Pedido</button>
						</div>
                    </form>
                </div>
            </div>
		...
		<table class="table table-striped table-hover table-condensed">
			...
			<tbody>
				<tr ng-repeat="resultado in resultados" ng-click="SetearSeleccionado()">
					...
					<td>{{resultado.precio | currency:undefined:0 | comaPorPunto}}</td>
                    <td>{{resultado.cantidad_stock.replace('.000','')}} <br> {{resultado.nom_marca}}</td>
				</tr>
			</tbody>
		</table>
	  </p>
    ...
    <div class="modal-body">
        <p id="mensajeModalOpcionesClientes">
            <div class="col-md-12 col-sm-12 col-xs-12" style="text-align:center;">
                <button type="button" ng-hide="true" class="btn btn-primary" ng-click="BuscarCliente()">Buscar Cliente</button>
    ...
    <div class="modal-body">
      <p id="mensajeModalSeleccionarClienteRuta">
        ...
        <table class="table table-striped table-hover">
            ...
            <tbody>
                <tr ng-repeat="cliente in clientesRuta" ng-click="SeleccionarClienteRuta()">
        ...
        <table class="table table-striped table-hover">
            ...
            <tbody>
                <tr ng-repeat="cliente in clientesRutaEntregados" ng-click="SeleccionarClienteRuta()">
                    <td>{{cliente.razon_social}} </td>
                    <td>{{cliente.nom_local_cliente}}</td>
                </tr>
            </tbody>
        ...
        <table class="table table-striped table-hover">
            ...
            <tbody>
                <tr ng-repeat="cliente in clientesRutaBloqueados" ng-click="SeleccionarClienteRuta()">
                    <td>{{cliente.razon_social}} </td>
                    <td>{{cliente.nom_local_cliente}}</td>
                </tr>
            </tbody>
