...
<div id="terminalVentas">
    <form action="javascript:agregarProducto()">
        ...
        <inout type="hidden" id="idPedido" value="" />
        <input type="hidden" id="topeVenta" value="" />
        <input type="hidden" id="topeCredito" value="" />
        ...
        <h1>
            <table>
                <tr>
                    <td>Seleccione Empresa:
                        <select id="cmbEmpresa" onchange="javascript:cambiarEmpresa(this.value)">
                            <?php
                                $i = 0;
                                while($i <= $numEmpresas) {
                                    echo "<option value='" . $listaEmpresa[$i]->getAccesoRapido() . "' name='" . $listaEmpresa[$i]->getRutEmpresa() . "'>" 
                                            . $listaEmpresa[$i]->getRazonSocial() . "</option>";
                                    $i++;
                                }
                            ?>
                        </select>
                        ...
                        <div id="datosVenta">
                            ...
                            <?php
                                ...
                                while($i <= $numTiposPago) {
                                    echo "<option value='" . $listaTipoPago[$i]->getIdTipoDocto() . "'>" . $listaTipoPago[$i]->getNomTipoDocto() . "</option>";
                                    $i++;
                                }
                            ?>
                            </select>
                        ...
                        <div id="buscarPedidos">Buscar Pedido</div>
                        <br /><br />
