 ...
 ************************************************************/
    ...
    class LocalCliente {
        ...
        function modLocalCliente($idLocalCliente, $nomLocalCliente, $direLocalClie, $fonoLocalClie, $emailLocalClie, 
                                 $nomContacto, $apellPatContacto, $apellMatContacto, $fonoContacto, $emailContacto, 
                                 $topeVenta, $topeCredito, $idFormaPago, $comuna, $observaciones,
                                 $giro, $bPermiteVentaTopeMensual, $idUsuMod) {
        /************************************************************
         * Autor: Christian Castro                                  *
         * Fecha: 28-12-2011                                        *
         * Desc : Modifica a un local de cliente                    *
         ...
         ************************************************************/
            ...
            $query = "UPDATE 10_m_local_cliente
                          SET nom_local_cliente       = '" . $nomLocalCliente . "',
                              ...
                              telefono_contacto       = '" . $fonoContacto . "',
                              email_contacto          = '" . $emailContacto . "',
                              tope_venta              = " . $topeVenta . ",
                              tope_credito            = " . $topeCredito . ",
